...
from nfe.models import ODEModel, CouplingFlow, ResNetFlow, GruFlow, MLPFlow
    ...
    def get_model(self, args):
        if args.model == 'ode':
            ...
            if args.flow_model == 'coupling':
                ...
                return GruFlow(self.dim, args.flow_layers, [args.hidden_dim] * args.hidden_layers,
                                  args.time_net, args.time_hidden_dim)
            elif args.flow_model == 'mlp':
                return MLPFlow(self.dim, args.flow_layers, [args.hidden_dim] * args.hidden_layers, activation='ReLU')
